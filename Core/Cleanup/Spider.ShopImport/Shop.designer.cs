...
namespace Spider.ShopImport
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="MyCom_Shop_Content")]
    ...
    partial void DeleteVendorStock(VendorStock instance);
		...
		public ShopDataContext() : 
				base(global::Spider.ShopImport.Properties.Settings.Default.MyCom_Shop_ContentConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	[Table(Name="dbo.ProductBarcodes")]
    ...
    partial void OnLastModificationTimeChanged();
		...
		[Column(Storage="_Barcode", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_BarcodeType", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
    ...
    partial void OnProductDeskChanged();
		...
		[Column(Storage="_ShortDescription", DbType="NVarChar(150) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_LongDescription", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Product_ProductGroup", Storage="_ProductGroups", ThisKey="ProductID", OtherKey="FeaturedProductID")]
		...
		[Association(Name="Product_ProductAttribute", Storage="_ProductAttributes", ThisKey="ProductID", OtherKey="ProductID")]
    ...
    partial void OnSerialNumberRequiredChanged();
		...
		[Column(Storage="_ProductGroupCode", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_BackendProductGroupCode", DbType="VarChar(10)")]
		...
		[Column(Storage="_ParentProductGroupID", DbType="Int")]
		...
		[Column(Storage="_FeaturedProductID", DbType="Int")]
		...
		[Column(Storage="_SerialNumberRequired", DbType="Bit NOT NULL")]
		...
		[Association(Name="ProductGroup_ProductAttribute", Storage="_ProductAttributes", ThisKey="ProductGroupID", OtherKey="ProductGroupID")]
		public EntitySet<ProductAttribute> ProductAttributes
		{
			get
			{
		...
		[Association(Name="ProductGroup_ProductGroupsAttributeMetaData", Storage="_ProductGroupsAttributeMetaDatas", ThisKey="ProductGroupID", OtherKey="ProductGroupID")]
		...
		[Association(Name="Product_ProductGroup", Storage="_Product", ThisKey="FeaturedProductID", OtherKey="ProductID", IsForeignKey=true)]
	...
	[Table(Name="dbo.AttributeMetaData")]
    ...
    partial void OnLastModificationTimeChanged();
		...
		[Column(Storage="_AttributeMetaDataID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_AttributeName", DbType="NVarChar(100)")]
		...
		[Column(Storage="_DataTypeID", DbType="Int")]
		...
		[Column(Storage="_FormatString", DbType="NVarChar(100)")]
		...
		[Association(Name="AttributeMetaData_ProductAttribute", Storage="_ProductAttributes", ThisKey="AttributeMetaDataID", OtherKey="AttributeMetaDataID")]
		public EntitySet<ProductAttribute> ProductAttributes
		{
			get
			{
		...
		[Association(Name="AttributeMetaData_ProductGroupsAttributeMetaData", Storage="_ProductGroupsAttributeMetaDatas", ThisKey="AttributeMetaDataID", OtherKey="AttributeMetaDataID")]
		public EntitySet<ProductGroupsAttributeMetaData> ProductGroupsAttributeMetaDatas
		{
			get
			{
	...
	[Table(Name="dbo.ProductAttributes")]
    ...
    partial void OnLastModificationTimeChanged();
		...
		[Column(Storage="_ProductAttributeID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_AttributeMetaDataID", DbType="Int NOT NULL")]
		public int AttributeMetaDataID
		{
			get
			{
		...
		[Column(Storage="_AttributeValue", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Product_ProductAttribute", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
		...
		[Association(Name="AttributeMetaData_ProductAttribute", Storage="_AttributeMetaData", ThisKey="AttributeMetaDataID", OtherKey="AttributeMetaDataID", IsForeignKey=true)]
		...
		[Association(Name="ProductGroup_ProductAttribute", Storage="_ProductGroup", ThisKey="ProductGroupID", OtherKey="ProductGroupID", IsForeignKey=true)]
	...
	[Table(Name="dbo.ProductGroupsAttributeMetaData")]
    ...
    partial void OnLastModificationTimeChanged();
		...
		[Column(Storage="_ProductGroupID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int ProductGroupID
		{
			get
			{
		...
		[Column(Storage="_IsQuickSearch", DbType="Bit")]
		...
		[Column(Storage="_OrderIndex", DbType="Int")]
		...
		[Association(Name="AttributeMetaData_ProductGroupsAttributeMetaData", Storage="_AttributeMetaData", ThisKey="AttributeMetaDataID", OtherKey="AttributeMetaDataID", IsForeignKey=true)]
		public AttributeMetaData AttributeMetaData
		{
			get
			{
		...
		[Association(Name="ProductGroup_ProductGroupsAttributeMetaData", Storage="_ProductGroup", ThisKey="ProductGroupID", OtherKey="ProductGroupID", IsForeignKey=true)]
		public ProductGroup ProductGroup
		{
			get
			{
    ...
    partial void OnLastModificationTimeChanged();
		...
		[Column(Storage="_RelationID", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_StockLocationID", DbType="VarChar(40) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_VendorProductID", DbType="VarChar(50)")]
		...
		[Column(Storage="_VendorProductStatus", DbType="VarChar(2)")]
		...
		[Column(Storage="_QuantityOnHand", DbType="Int NOT NULL")]
