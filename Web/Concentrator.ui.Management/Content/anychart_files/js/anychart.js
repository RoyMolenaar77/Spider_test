...
//        $(window).trigger('quickscanComplete', {
//            responseText: htmlCode
...
//        });
    ...
    */
    setXMLFile: function(path) {
        ...
        if (this.flashObject != null) {
//            $(this.flashObject).attr('flashvars', this._buildFlashVars());

                  this.flashObject.attributes.getNamedItem('flashvars').value = this._buildFlashVars();
        }
    },
