...
{
  public abstract class VendorImportLoader<TContext> : BulkLoader<TContext>
    where TContext : ObjectContext, new()
  {
    ...
    public VendorImportLoader()
    {

    }

    public VendorImportLoader(string baseURI, NetworkCredential credentials)
    {
