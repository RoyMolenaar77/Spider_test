...
/****** Object:  View [dbo].[CalculatedPriceView]    Script Date: 4/15/2014 11:12:00 AM ******/
SET ANSI_NULLS ON
GO
...
select * from (  
      select    
            ...
            ROW_NUMBER() OVER (PARTITION BY c.ProductID, c.connectorid ORDER BY ContentPriceRuleIndex) AS RankNumber,  
