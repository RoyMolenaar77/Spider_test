alter table connectorproductstatus drop column publish
alter table connectorproductstatus drop column publishonlywithstock

/****** Object:  View [dbo].[AssortmentContentView]    Script Date: 02/22/2011 08:52:58 ******/
SET ANSI_NULLS ON
GO
...
SELECT 
      ...
      FROM Content C 
            ...
            inner JOIN ConnectorProductStatus cps on cps.ConcentratorStatusID = vp.ConcentratorStatusID and cps.ConnectorID = c.ConnectorID
      --, [Language] L
      --AND L.LanguageID =2
