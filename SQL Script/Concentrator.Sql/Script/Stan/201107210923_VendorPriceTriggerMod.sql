...
/****** Object:  Trigger [dbo].[VendorPriceLedger]    Script Date: 07/21/2011 09:22:53 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER TRIGGER [dbo].[VendorPriceLedger] 
   ON  [dbo].[VendorPrice] 
   AFTER Insert, UPDATE
AS 
BEGIN
	...
	SET NOCOUNT ON;
     ...
     select va.ProductID, getdate(), i.price, i.costprice, i.taxrate, i.concentratorstatusid, i.minimumquantity, i.vendorassortmentid, 'Inserted/Updated vendor price', 'VendorPrice', 0, getdate(), i.baseprice, i.basecostprice
     from inserted i 
