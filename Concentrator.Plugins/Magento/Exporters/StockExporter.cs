...
namespace Concentrator.Plugins.Magento.Exporters
{
  public class StockExporter : BaseExporter
  {
    ...
    private List<AssortmentStockPriceProduct> AssortmentToDeactivate;
    ...
    public StockExporter(Connector connector, IAuditLogAdapter logger, string serializationPath)
