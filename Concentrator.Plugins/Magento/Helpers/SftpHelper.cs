...
namespace Concentrator.Plugins.Magento.Helpers
{
  ...
  public class SftpHelper
  {
    ...
    public static FtpInfo GetFtpTriggerIndexInfo(Objects.Models.Connectors.Connector Connector)
    {
      return new FtpInfo
      {
        FtpAddress = !string.IsNullOrEmpty(Connector.ConnectorSettings.GetValueByKey<string>("FtpAddress", null))
                     ? Connector.ConnectorSettings.GetValueByKey<string>("FtpAddress", null)
                     : Connector.ParentConnector.ConnectorSettings.GetValueByKey<string>("FtpAddress", null),
        FtpUserName = !string.IsNullOrEmpty(Connector.ConnectorSettings.GetValueByKey<string>("FtpUserName", null))
                      ? Connector.ConnectorSettings.GetValueByKey<string>("FtpUserName", null)
                      : Connector.ParentConnector.ConnectorSettings.GetValueByKey<string>("FtpUserName", null),
        FtpPassword = !string.IsNullOrEmpty(Connector.ConnectorSettings.GetValueByKey<string>("FtpPassword", null))
                      ? Connector.ConnectorSettings.GetValueByKey<string>("FtpPassword", null)
                      : Connector.ParentConnector.ConnectorSettings.GetValueByKey<string>("FtpPassword", null),
        FtpPath = !string.IsNullOrEmpty(Connector.ConnectorSettings.GetValueByKey<string>("TrgFilePath", null))
                  ? Connector.ConnectorSettings.GetValueByKey<string>("TrgFilePath", null)
                  : Connector.ParentConnector.ConnectorSettings.GetValueByKey<string>("TrgFilePath", null)
      };
    }
    ...
    public static FtpInfo GetFtpInfo(Objects.Models.Connectors.Connector Connector)
    {
      return new FtpInfo
      {
        ...
        FtpPassword = !string.IsNullOrEmpty(Connector.ConnectorSettings.GetValueByKey<string>("FtpPassword", null))
                      ? Connector.ConnectorSettings.GetValueByKey<string>("FtpPassword", null)
                      : Connector.ParentConnector.ConnectorSettings.GetValueByKey<string>("FtpPassword", null),
        FtpPath = !string.IsNullOrEmpty(Connector.ConnectorSettings.GetValueByKey<string>("FtpPath", null))
                  ? Connector.ConnectorSettings.GetValueByKey<string>("FtpPath", null)
                  : Connector.ParentConnector.ConnectorSettings.GetValueByKey<string>("FtpPath", null)
      };
    }
  }
}
