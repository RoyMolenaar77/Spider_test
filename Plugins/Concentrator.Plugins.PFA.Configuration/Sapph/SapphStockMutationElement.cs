...
{
  /// <summary>
  /// Represents the information for handling the stock mutations.
  /// </summary>
  public sealed class SapphStockMutationElement : ConfigurationElement
  {
    ...
    /// </summary>
    [ConfigurationProperty ( VendorNameKey , DefaultValue = "Sapph" )]
