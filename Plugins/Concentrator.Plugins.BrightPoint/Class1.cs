...
//{
//    public class ProductImport : VendorBase//ConcentratorPlugin
//    {
...
//                VendorID = Int32.Parse(ConfigurationManager.AppSettings["CBVendorID"]);
//                DefaultVendorID = Int32.Parse(ConfigurationManager.AppSettings["CBDefaultVendorID"]);
...
//                // Retrieves the file
//                var path = ConfigurationManager.AppSettings["CentraalBoekhuisDirectory"];
//                var fileName = ConfigurationManager.AppSettings["CentraalBoekhuisFile"];
...
//                                                       let attributeID = attributeList.ContainsKey(attr) ? attributeList[attr] : 2//-1
