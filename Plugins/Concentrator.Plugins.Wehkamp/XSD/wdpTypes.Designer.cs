...
namespace Concentrator.Plugins.Wehkamp
{
  ...
  public partial class headerType
  {
    ...
    //[System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
    [XmlIgnore]
    public System.DateTime berichtDatumTijd { get; set; }

    [XmlElement("berichtDatumTijd")]
    public string BerichtDatumTijdString
    {
      get
      {
        return berichtDatumTijd.ToString("yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture);
      }

      set
      {
        DateTime dateTime = DateTime.Now;
        if (DateTime.TryParseExact(value, "yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture,  DateTimeStyles.AssumeLocal, out dateTime))
          berichtDatumTijd = dateTime;
      }
    }
    ...
    public static headerType Deserialize(System.IO.Stream s)
    {
      return ((headerType)(Serializer.Deserialize(s)));
    }
