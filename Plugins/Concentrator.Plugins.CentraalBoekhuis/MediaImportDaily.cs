...
{
  public class MediaImportDaily : MediaImportBase
  {
    private const string _name = "Centraal Boekhuis Media Daily";
    ...
    public void Process()
    {
      ...
      FtpManager ftp = new FtpManager(config["CentraalBoekhuisFtpUrl"].Value, config["CentraalBoekhuisCoverPath"].Value,
      ...
      log.AuditComplete("Finished Daily Centraal Boekhuis Media Import", "Centraal Boekhuis Media Import");
    }
